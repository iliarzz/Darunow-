  ...
  return (
    <main dir="rtl" lang="fa" className="relative min-h-screen bg-[#070A0F] text-white no-copy">
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -top-52 left-1/2 h-[640px] w-[640px] -translate-x-1/2 rounded-full bg-[#1D456B]/55 blur-[140px] animate-floatSlow" />
        <div className="absolute top-20 right-[-200px] h-[480px] w-[480px] rounded-full bg-[#7EB3CC]/25 blur-[140px] animate-floatSlower" />
