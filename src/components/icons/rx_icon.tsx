...
export function IconRx({ size = 20, ...rest }: { size?: number } & React.SVGProps<SVGSVGElement>) {
  return (
    <IconBase size={size} {...rest}>
      <rect x="12" y="8" width="24" height="32" rx="4" fill={navy} />
      <text x="16" y="28" fill="white" fontSize="12" fontFamily="sans-serif" fontWeight="bold">
        Rx
      </text>
